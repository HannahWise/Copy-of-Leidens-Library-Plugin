...
$(document).ready(function () {
    ...
    $('#btnOpenNewTab').click(function () {
        ...
        if (
            ...
            var newLibraryURL = 'http://www.google.co.uk' + searchstring + '&source=CopyofLeidensLibraryPlugin'; //you can modofy &source to anything you like. This is useful to see how many users are coming to your catalogue via the plugin, in Google Analytics.
            // Create the new tab
            chrome.tabs.create({
                url: newLibraryURL
            });
...
var searches = [
    {
        ...
        url: "http://surrey-primotc.hosted.exlibrisgroup.com/openurl/44SUR/44SUR_services_page=LibrarySearchPluginPublic"
  },
    {
